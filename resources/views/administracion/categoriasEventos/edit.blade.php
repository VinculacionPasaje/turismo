...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            {{Form::model($categoria, ['route' => ['categoriasEventos.update',$categoria->id],'method'=>'PUT' ])}}
                <input type="hidden" name="ruta" id ="ruta" value="{{url('')}}">
                <div class="form-group">
                    {!! Form::label('Categoria') !!}
                    {!! Form::text('categoria',null,['placeholder'=>'Categoria','class'=>'form-control','onkeypress'=>'return soloLetras(event)']) !!}
                </div>
                <div class="form-group">
