                ...
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                     ...
                     <div class= "col-xs-6 col-md-6">
                            ...
                            <div class="box-tools">
                                {!! Form::open(['route'=>'categoriasDiversion.index', 'method'=> 'GET', 'class'=>'navbar-form navbar-left pull-right', 'role'=>'search']) !!}
                                <div class="input-group input-group-sm" style="width: 350px;">
                                    ...
                                    <div class="input-group-btn">
                                     ...
                                     <div class="input-group-btn">
                                    <a href="{{route('categoriasDiversion.index')}}" class="btn btn-primary btn-sm" role="button">Mostrar Todos</a>
                                     </div>
