...
class ComentariosEventosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return View('administracion.ComentariosEventos.index',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','comentarios'));
    }
    ...
    public function noAprovados(Request $request)
    {
        ...
        return View('administracion.ComentariosEventos.noAprovados',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','comentarios'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        $comment->eventos_id= $id;
         ...
         if($comment->save()){
            return Redirect::to('eventos/'.$id)->with('mensaje-registro', 'Comentario enviado, pasará por moderación antes de ser publicado en el sitio web');
    ...
    public function edit($id)
    {
        ...
        return view('administracion.ComentariosEventos.edit',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','comentarios'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($comentarios->save()){
            ...
            if($enviarEmail==1){ // si el administrador activo para enviar la respuesta por email
                ...
                return Redirect::to('administracion/comentariosEventos')->with('mensaje-registro', 'Email enviado Correctamente');
