...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            {{Form::model($turismo, ['route' => ['turismo.update',$turismo->id],'method'=>'PUT' ])}}
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker" name = "fecha" value="{{$turismo->fecha}}">
                </div>
            </div>
