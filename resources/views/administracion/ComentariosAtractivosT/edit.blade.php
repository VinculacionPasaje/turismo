...
@section('contenido')
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Edición de Comentarios de Atractivos Turísticos</h3>
        </div><!-- /.box-header -->

        <div id="notificacion_resul_fanu"></div>
        <div class="box-body">
            {{Form::model($comentarios, ['route' => ['comentariosTuristicos.update',$comentarios->id],'method'=>'PUT' ])}}
