...
class RedesController extends Controller
{
    public function edit($id){
        ...
        return view('administracion.redes.edit',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','redes'));
    ...
    public function index(Request $request){
        ...
        return view('administracion.redes.index',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','redes'));
