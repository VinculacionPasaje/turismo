...
@section('contenido')
                ...
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                     ...
                     <div class= "col-xs-6 col-md-6">
                            ...
                            <div class="box-tools">
                                {!! Form::open(['route'=>'categoriasAlimentacion.index', 'method'=> 'GET', 'class'=>'navbar-form navbar-left pull-right', 'role'=>'search']) !!}
                                <div class="input-group input-group-sm" style="width: 350px;">
                                    ...
                                    <div class="input-group-btn">
                                     ...
                                     <div class="input-group-btn">
                                    <a href="{{route('categoriasAlimentacion.index')}}" class="btn btn-primary btn-sm" role="button">Mostrar Todos</a>
                                     </div>
                                ...
                                @foreach($cat as $categoria)
                                 @if($categoria->estado !=0)
                                    <tr data-id="{{$categoria->id}}">
                                        ...
                                        <td>
                                            {!!link_to_route('categoriasAlimentacion.edit', $title = 'Editar', $parameters = $categoria->id, $attributes = ['class'=>'btn  btn-primary btn-sm'])!!}
    ...
    {!! Form::open(['route' => ['categoriasAlimentacion.destroy', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('script')
