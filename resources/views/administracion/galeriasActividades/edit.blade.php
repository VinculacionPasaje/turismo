...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            {{Form::model($galeria, ['route' => ['galeriasActividades.update',$galeria->id],'method'=>'PUT','files' => true ])}}
            ...
            <div class="row" ><!--Inicio de row -->
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <select class="form-control" name="actividades_id" id="categorias" style="width: 100%;" >
                        <option value="" disabled selected>Seleccione la categoria</option>

                            @foreach($categorias as $categoria)
                                    @if($categoria->id == $galeria->actividades->id)
