...
@section('contenido')
                ...
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                     ...
                     <div class= "col-xs-6 col-md-6">
                            ...
                            <div class="box-tools">
                                {!! Form::open(['route'=>'actividades.index', 'method'=> 'GET', 'class'=>'navbar-form navbar-left pull-right', 'role'=>'search']) !!}
                                <div class="input-group input-group-sm" style="width: 350px;">
                                    ...
                                    <div class="input-group-btn">
                                     ...
                                     <div class="input-group-btn">
                                    <a href="{{route('actividades.index')}}" class="btn btn-primary btn-sm" role="button">Mostrar Todos</a>
                                     </div>
                                ...
                                @foreach($busqueda as $noticia)
                                 @if($noticia->estado !=0)
                                    <tr data-id="{{$noticia->id}}">
                                        ...
                                        <td>
                                            {!!link_to_route('actividades.edit', $title = 'Editar', $parameters = $noticia->id, $attributes = ['class'=>'btn  btn-primary btn-sm'])!!}
    ...
    {!! Form::open(['route' => ['actividades.destroy', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('script')
