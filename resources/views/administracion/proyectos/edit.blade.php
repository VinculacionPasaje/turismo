...
@section('title')
    <section class="content-header">
        <h1>Proyectos<small>Editar</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div id="msj-success" class="alert alert-success alert-dismissible aprobado" role="alert" style="display:none">
                <strong> Proyecto Editado Correctamente.</strong>
            </div>
            ...
            <div class="row" ><!--Inicio de row -->
                ...
                <div class="col-md-6 col-xs-12">
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker" name = "fecha_post" value="{{$proyecto->fecha_post}}">
                        </div>
                    </div>
                </div>
