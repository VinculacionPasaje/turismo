...
@section('title')
    <section class="content-header">
        <h1>Alimentación<small>Editar</small></h1>
        <ol class="breadcrumb">
...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            {{Form::model($alimentacion, ['route' => ['alimentacion.update',$alimentacion->id],'method'=>'PUT','files' => true ])}}
                ...
                <div class="col-md-6 col-xs-12">
                         <div class="form-group">
                           {!! Form::label('Fecha de Publicación') !!}
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker" name = "fecha_post" value="{{$alimentacion->fecha_post}}">
                        </div>
                    </div>
                </div>
                    ...
                    <select class="form-control" name="id_categorias" id="categorias" style="width: 100%;" >
                         <option value="" disabled selected>Seleccione uno</option>
                            ...
                            @foreach($categorias as $categoria)
                                    @if($categoria->id == $alimentacion->categoria->id)
            ...
            <div class="row" ><!--Inicio de row -->
                 <div class="col-md-4 col-xs-12">
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Telefono" onkeypress="return soloNumeros(event)" maxlength="20" value="{{$alimentacion->telefono }}">
                        </div>
                </div>
                    ...
                    <select class="form-control" name="id_parroquias" id="parroquias" style="width: 100%;" >
                         <option value="" disabled selected>Seleccione la Parroquia</option>
                            ...
                            @foreach($parroquias as $parroquia)
                                    @if($parroquia->id == $alimentacion->parroquias->id)
