            ...
            <div class="box">
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                        <h3 class="box-title">Comentarios No Aprobados de los Sitios de Diversión de Pasaje</h3>
                     ...
                     <div class= "col-xs-6 col-md-6">
                            ...
                            <div class="box-tools">
                                  <div class="input-group-btn">
                                    <a href="{{route('comentariosDiversion.noAprovados')}}" class="btn btn-primary btn-sm" role="button">Mostrar Todos</a>
                                     </div>
