...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            {!!Form::open(['route' => 'proyectos.store','method'=>'POST','files' => true,'id'=>'form'])!!}
            <div id="msj-success" class="alert alert-success alert-dismissible aprobado" role="alert" style="display:none">
                <strong> Proyectoo Agregado Correctamente.</strong>
            </div>
            <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
            @include('administracion.proyectos.form.create')
