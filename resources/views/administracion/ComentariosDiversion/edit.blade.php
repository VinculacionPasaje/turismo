...
@section('contenido')
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Edición de Comentarios de Sitios de Diversión de Pasaje</h3>
        </div><!-- /.box-header -->

        <div id="notificacion_resul_fanu"></div>
        <div class="box-body">
            {{Form::model($comentarios, ['route' => ['comentariosDiversion.update',$comentarios->id],'method'=>'PUT' ])}}
