...
<img src="{{url('frontend/images/proyectos.jpg')}}" alt="">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="item-lists">
                            ...
                            @if (count($actividades) > 0)
                                ...
                                @include('ajax-frontend/proyectos')
...
@section('derecho')
                    ...
                    <ul class="demo1" style="overflow-y: hidden; margin-bottom: 0px;">
                        ...
                        @foreach($noticias as $noticia)   
                            ...
                            <td>
                                 <h5 class="negro"><a class="negro" href="proyectos/{{$noticia->id}}">{{$noticia->titulo}}</a></h5>
                        ...
                        @endforeach
                            ...
                            <div class="panel-footer">
                                ...
                                <a class="btn_noticias" href="{{url ('proyectos')}}">Ver Más Proyectos</a>
