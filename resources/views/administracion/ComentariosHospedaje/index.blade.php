...
@section('contenido')
            ...
            <div class="box">
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                        <h3 class="box-title">Comentarios de los Hospedajes de Pasaje</h3>
                     ...
                     <div class= "col-xs-6 col-md-6">
                            ...
                            <div class="box-tools">
                                {!! Form::open(['route'=>'comentariosHospedaje.index', 'method'=> 'GET', 'class'=>'navbar-form navbar-left pull-right', 'role'=>'search']) !!}
                                <div class="input-group input-group-sm" style="width: 350px;">
                                    ...
                                    <div class="input-group-btn">
                                     ...
                                     <div class="input-group-btn">
                                    <a href="{{route('comentariosHospedaje.index')}}" class="btn btn-primary btn-sm" role="button">Mostrar Todos</a>
                                     </div>
                                 ...
                                 @if($noticia->estado !=0)
                                    <tr data-id="{{$noticia->id}}">
                                     ...
                                     <td>{{$noticia->nombre}}</td>
                                        ...
                                        <td>
                                            {!!link_to_route('comentariosHospedaje.edit', $title = 'Editar', $parameters = $noticia->id, $attributes = ['class'=>'btn  btn-primary btn-sm'])!!}
    ...
    {!! Form::open(['route' => ['comentariosHospedaje.destroy', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('script')
