...
@section('contenido')
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Edición de Contenido Materiales Turisticos</h3>
        </div><!-- /.box-header -->
            ...
            {{Form::model($material, ['route' => ['material.update',$material->id],'method'=>'PUT' ])}}
             ...
             <div class="form-group">
                ...
                <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker" name = "fecha" value="{{$material->fecha}}">
                </div>
            </div>
