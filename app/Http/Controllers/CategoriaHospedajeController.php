...
class CategoriaHospedajeController extends Controller
{
    public function index(Request $request){
       ...
       $comentariosNoticias = ComentariosNoticias::where('aprovado',0)->count();
        $total= $comentariosNoticias+$comentariosAtractivosT+$comentariosHospedaje+$comentariosDiversion+$comentariosEventos+ $comentariosAlimentacion+$comentariosActividades;
          ...
          return view('administracion.categoriasHospedaje.index',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','categorias', 'cat'));
    ...
    public function create(){
        ...
        return view ('administracion.categoriasHospedaje.create', compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos'));
    }
    ...
    public function edit($id){
       ...
       $comentariosNoticias = ComentariosNoticias::where('aprovado',0)->count();
        ...
        return view('administracion.categoriasHospedaje.edit',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','categoria'));
