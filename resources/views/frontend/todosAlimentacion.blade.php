                                                ...
                                                <div class="line"> 
                                                    <div class="text hide-s">
                                                        ...
                                                        <p>{{$act->descripcion}}
                                                         ...
                                                         {!!link_to('alimentacion/'.$act->id.'', $title = 'Más Información', $attributes = ['class'=>'slider_btn_banner'], $secure = null)!!}
...
<div class="container" style="padding-bottom: 70px; padding-top: 25px;">
       ...
       <div class="row header">
            <div class="col-md-12">
                    ...
                    <p class="contact"> Todas los lugares de Alimentación </p>
                                ...
                                <div class="blog-post blog-large">
                                    <article>
                                        <header class="entry-header">
                                            ...
                                            <h3 class="entry-title"><a href="#">{{$act->nombre_lugar}}</a></h3>
                                        </header>

                                        <div align="center">
                                            <P class="negro2">{{$act->descripcion}}</P>
                                            {!!link_to('alimentacion/'.$act->id.'', $title = 'Más Información', $attributes = ['class'=>'slider_btn4'], $secure = null)!!}
