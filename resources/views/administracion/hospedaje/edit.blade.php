...
@section('title')
    <section class="content-header">
        <h1>Hospedaje<small>Editar</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Inicio</a></li>
            <li class="active">Hospedaje</li>
...
@section('contenido')
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Editar Hospedaje</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            {{Form::model($hospedaje, ['route' => ['hospedaje.update',$hospedaje->id],'method'=>'PUT','files' => true ])}}
                ...
                <div class="col-md-6 col-xs-12">
                         <div class="form-group">
                           {!! Form::label('Fecha de Publicación') !!}
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker" name = "fecha_post" value="{{$hospedaje->fecha_post}}">
                        </div>
                    </div>
                </div>
                    ...
                    <select class="form-control" name="id_categorias" id="categorias" style="width: 100%;" >
                         <option value="" disabled selected>Seleccione tipo de Hospedaje</option>
                            ...
                            @foreach($categorias as $categoria)
                                    @if($categoria->id == $hospedaje->categoria->id)
            ...
            <div class="row" ><!--Inicio de row -->
                 <div class="col-md-4 col-xs-12">
                       <div class="form-group">
                            ...
                            <select class="form-control" name="estrellas" id="estrellas" style="width: 100%;" >
                ...
                <div class="col-md-4 col-xs-12">
                 ...
                 <label>Seleccione la Ubicación del Hospedaje</label>
                    ...
                    <select class="form-control" name="id_parroquias" id="parroquias" style="width: 100%;" >
                         <option value="" disabled selected>Seleccione la Parroquia</option>
                            ...
                            @foreach($parroquias as $parroquia)
                                    @if($parroquia->id == $hospedaje->parroquias->id)
