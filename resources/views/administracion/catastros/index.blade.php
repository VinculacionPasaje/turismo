...
@section('contenido')
            ...
            <div class="box">
                <div class="box-header">
                    <div class= "col-xs-6 col-md-6" aling="center">
                        <h3 class="box-title">Catastros Registrados</h3>
                                ...
                                @foreach($busqueda as $noticia)
                                 @if($noticia->estado !=0)
                                    <tr data-id="{{$noticia->id}}">
                                        ...
                                        <td>
                                            {!!link_to_route('catastros.edit', $title = 'Editar', $parameters = $noticia->id, $attributes = ['class'=>'btn  btn-primary btn-sm'])!!}
                ...
                @else
                    <br/><div class='rechazado'><label style='color:#FA206A'>...No se ha encontrado ningún catastro...</label>  </div>
                @endif
    ...
    {!! Form::open(['route' => ['catastros.destroy', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('script')
