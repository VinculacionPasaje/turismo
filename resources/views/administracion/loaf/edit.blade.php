...
@section('contenido')
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Edición de Contenido LOAF</h3>
        </div><!-- /.box-header -->

        <div id="notificacion_resul_fanu"></div>
        <div class="box-body">
            {{Form::model($loaf, ['route' => ['loaf.update',$loaf->id],'method'=>'PUT','files' => true ])}}
           ...
           <div class="row" ><!--Inicio de row -->
                 ...
                 <div class="col-md-6 col-xs-12">
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker" name = "fecha_post" value="{{$loaf->fecha_post}}">
                        </div>
                    </div>
                </div>
