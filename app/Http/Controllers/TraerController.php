...
class TraerController extends Controller
{
     public function edit($id){
        ...
        return view('administracion.traer.edit',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','traer'));
    ...
    public function index(Request $request){
        ...
        return view('administracion.traer.index',compact('comentariosNoticias','total','comentariosActividades','comentariosAlimentacion','comentariosAtractivosT', 'comentariosHospedaje', 'comentariosDiversion', 'comentariosEventos','traer'));
